...
public class UploadMain extends AppCompatActivity {
            ...
            fileReference.putFile(mImageUri).continueWithTask(
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(UploadMain.this, "image_main failed: " + task.getException().getMessage(), Toast.LENGTH_LONG).show();
                            }
                        }
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(UploadMain.this, e.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    });
        } else {
    ...
    {
        Intent intent = new Intent(UploadMain.this, UploadImages.class);
